...
[Node.js:](https://nodejs.org/en/)
 A JavaScript runtime environment. It is used to run JavaScript on a machine rather than in a browser.
...
![](/MogoDB-Network-Access.png)



Create a MongoDB database and collection inside mLab

![](/Mongo-create-DB-1.png)



![](/Mongo-create-DB-2.png)
...
Click [Install Postman](https://www.postman.com/downloads/)

 to download and install postman on your machine.

Click [HERE](https://www.youtube.com/watch?v=FjgYtQK_zLE&ab_channel=ValentinDespa) to learn how perform [CRUD operartions](https://en.wikipedia.org/wiki/Create,_read,_update_and_delete) on Postman
...
3. Add the key value pair in 

the package.json file "proxy":
 "http://localhost:5000".
...
## STEP 2 - FRONTEND CREATION(CONTINUED)
